...
import com.example.valefise.ExpDirectorio;
...
public class Main_Fragment extends Fragment {
    ...
    Activity a;
    public  Main_Fragment(Activity a){
        this.a = a;
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        impcli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(a, "Llenar el archivo clientes.cvs", Toast.LENGTH_SHORT).show();
                Intent mat = new Intent(a, ExpDirectorio.class);
                startActivity(mat);
            }
        });
        return  view;
